...
| ------------- |:-------------| 
| Name     | Gradebook | 
| Description    | file io and struct   |  
| Due date  | 22-Nov-22      |  
| Location     | https://github.com/katrmartin/CS1-krmartin3/tree/main/assignments/struct      |  
| Self-Grade | 100/100     |  
| Notes   | completed all the requirements and tested program many times; screenshots found in the same location   |
...
| Name        | Value           | 
| ------------- |:-------------| 
| Name     | Pointers, enum type, and namespace | 
| Description    | Demonstrates the usage of pointers, enum type and user-defined namespace with a calculator  |  
| Due date  | 19-Oct-22      |  
| Location     | https://github.com/katrmartin/CS1-krmartin3/tree/main/labs/lab7/pointers      |  
| Self-Grade | 100/100     |  
| Notes   | completed all requirements and did all fixmes, screenshot found in same location   |
